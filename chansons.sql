...
create table CHANTEUR ( -- individu ou groupe
  c_ref    integer constraint chanteur_pkey
                     primary key,
...
insert into CHANSON values (17,'manu', 1981);
...
insert into CHANTEUR values (18, 'renaud', null);
...
insert into DISQUE values (8,'night',1991,2);
...
insert into INTERPRETE values (7,17,1);
...
insert into INTERPRETE values (1,17,4);
